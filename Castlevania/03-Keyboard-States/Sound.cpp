...
void Sound::loadcontent()
{
	...
	loadSound("sound\\broken_brick.wav", "broken_brick");
	loadSound("sound\\hit.wav", "hit");
	loadSound("sound\\splashwater.wav", "splashwater");
	loadSound("sound\\man1.wav", "man1");
	loadSound("sound\\display_monney.wav", "display_monney");
	loadSound("sound\\holycross.wav", "holycross");
	loadSound("sound\\holywater.wav", "holywater");
	loadSound("sound\\InvisibilityPotion_Begin.wav", "InvisibilityPotion_Begin");
	loadSound("sound\\InvisibilityPotion_End.wav", "InvisibilityPotion_End");
	loadSound("sound\\opendoor.wav", "opendoor");
	loadSound("sound\\StopWatch.wav", "StopWatch");
	loadSound("sound\\usingdagger.wav", "usingdagger");
	loadSound("sound\\usingwhip.wav", "usingwhip");
	loadSound("sound\\hurting.wav", "hurting");
	loadSound("sound\\Axe.wav", "Axe");
	loadSound("sound\\collectitem.wav", "collectitem");
	loadSound("sound\\collectweapon.wav", "collectweapon");
	loadSound("music\\Stage_01_Vampire_Killer.wav", "backgroundmusic");
	loadSound("music\\Boss_Battle_Poison_Mind.wav", "backgroundmusic_boss");
	loadSound("music\\Life_Lost.wav", "Life_Lost");
	loadSound("music\\Game_Start_Prologue.wav", "Game_Start_Prologue");
